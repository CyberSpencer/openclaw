...
- `--port <port>`: WebSocket port (default comes from config/env; usually `32555`).
...
```bash
openclaw gateway health --url ws://127.0.0.1:32555
```
...
- `gatewayPort` (WebSocket port, usually `32555`)
