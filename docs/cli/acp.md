...
openclaw acp client --server-args --url wss://gateway-host:32555 --token <token>

# Override the server command (default: openclaw)
openclaw acp client --server "node" --server-args openclaw.mjs acp --url ws://127.0.0.1:55532
```
