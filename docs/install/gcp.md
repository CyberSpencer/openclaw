...
services:
  openclaw-gateway:
    ...
    ports:
      ...
      - "127.0.0.1:${OPENCLAW_GATEWAY_PORT}:32555"
...
```
[gateway] listening on ws://0.0.0.0:32555
```
...
```bash
gcloud compute ssh openclaw-gateway --zone=us-central1-a -- -L 32555:127.0.0.1:32555
```

Open in your browser:

`http://127.0.0.1:32555/`
