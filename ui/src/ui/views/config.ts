...
import { icons as uiIcons } from "../icons";
...
const sidebarIcons = {
  ...
  `,
  tools: uiIcons.wrench,
  gateway: uiIcons.globe,
  wizard: html`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      <path d="M15 4V2"></path>
