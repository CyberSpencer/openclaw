...
export function buildSubagentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "- Summary (1-3 bullets)",
    "- Work Completed (what you changed/found, with key specifics)",
    "- Evidence (commands run, tests, or logs, if applicable)",
    "- Risks / Follow-ups (anything the main agent should verify next)",
    "",
    "## What You DON'T Do",
