...
export const ExecApprovalRequestParamsSchema = Type.Object(
  {
    ...
    actionKind: Type.Optional(Type.Union([Type.String(), Type.Null()])),
    riskTags: Type.Optional(Type.Union([Type.Array(Type.String()), Type.Null()])),
    requiresOutbound: Type.Optional(Type.Union([Type.Boolean(), Type.Null()])),
    requiresElevation: Type.Optional(Type.Union([Type.Boolean(), Type.Null()])),
