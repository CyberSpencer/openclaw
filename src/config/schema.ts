...
const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.message.intentRouter.enabled": "Enable Intent Router",
  "tools.message.delivery.retry.enabled": "Enable Message Delivery Retry",
  "tools.message.delivery.retry.attempts": "Message Delivery Retry Attempts",
  "tools.message.delivery.retry.minDelayMs": "Message Delivery Retry Min Delay (ms)",
  "tools.message.delivery.retry.maxDelayMs": "Message Delivery Retry Max Delay (ms)",
  "tools.message.delivery.retry.jitter": "Message Delivery Retry Jitter",
  ...
  "skills.trustGate.level": "Skills Trust Gate Level",
  "skills.trustGate.warnThreshold": "Skills Trust Gate Warn Threshold",
  "skills.trustGate.blockThreshold": "Skills Trust Gate Block Threshold",
  "skills.trustGate.auditLogPath": "Skills Trust Gate Audit Log Path",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "tools.message.intentRouter.enabled":
    "Enable deterministic send/poll routing when channel is omitted (default: true).",
  "tools.message.delivery.retry.enabled": "Enable outbound send retries (default: true).",
  "tools.message.delivery.retry.attempts": "Max attempts including first send (default: 3).",
  "tools.message.delivery.retry.minDelayMs": "Initial retry delay in milliseconds (default: 300).",
  "tools.message.delivery.retry.maxDelayMs": "Maximum retry delay in milliseconds (default: 5000).",
  "tools.message.delivery.retry.jitter": "Retry jitter factor between 0 and 1 (default: 0.2).",
